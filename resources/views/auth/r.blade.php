...
<head>
    ...
    <title>Regiter && Login</title>



    <!-- Scripts -->
    @vite(['resources/sass/app.scss', 'resources/js/app.js', 'resources/sass/pageLoginAndRegister.scss'])
    <script src="{{ url('/css&js/jquery-3.6.4.min.js') }}"></script>
    <script src="{{ url('/css&js/jsPageEdit.js') }}"></script>
...
<body class="">
        ...
        <div class="main">
            <div class="container a-container" id="a-container">
                <form class="form" id="a-form" method="post" action="{{ route('register') }}">
                    ...
                    <input class="form__input @error('name') is-invalid @enderror" type="text" placeholder="Name"
                        name="name" value="{{ old('name') }}" required autofocus>
                    @error('name')
                        <strong>{{ $message }}</strong>
                    @enderror

                    <input class="form__input @error('email') is-invalid @enderror" name="email" placeholder="Email"
                    ...
                    <input class="form__input" type="password" name="password_confirmation" required placeholder="Confirm Password">
            ...
            <div class="container b-container" id="b-container">
                <form class="form" id="b-form" method="post" action="{{ route('login') }}">
                    ...
                    <input class="form__input @error('email') is-invalid @enderror" name="email" required autofocus
                        type="text" placeholder="Email">
                    @error('email')
                        <strong>{{ $message }}</strong>
                    @enderror
                    <input class="form__input @error('password') is-invalid @enderror" type="password" name="passowrd"
    ...
    <script src="{{ url('css&js/pageLoginAndRegister.js') }}"></script>
</body>
