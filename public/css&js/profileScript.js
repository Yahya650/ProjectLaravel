$(document).ready(function () {
    ...
    $("#fEditUser").submit(function (e) {
        ...
        //     $("#msgRequiredEditProfileIformation").addClass("d-none");
        ...
        // } else {
        //     e.preventDefault(); // Prevent form submission
        //     $("#msgRequiredEditProfileIformation").removeClass("d-none");
        // }

        // if (fileSize > maxSize) {
        //     e.preventDefault(); // Prevent form submission
        //     $("#msg").next().removeClass("d-none");
        //     $("#image").val("");
        // } else {
        //     $("#msg").next().addClass("d-none");
        // }
    });
